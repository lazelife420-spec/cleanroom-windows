...
![Cleanroom Proof Pack Demo](https://github.com/Z3r0DayZion-install/cleanroom-windows/releases/download/v1.0.1/cleanroom-proof-pack-demo.png)
...
# -> dist\Cleanroom-Setup-1.0.1.exe
```

### Verify provenance

Release artifacts are built by GitHub Actions and include artifact attestations. After downloading `Cleanroom-Setup-1.0.1.exe` from [Releases](https://github.com/Z3r0DayZion-install/cleanroom-windows/releases):
