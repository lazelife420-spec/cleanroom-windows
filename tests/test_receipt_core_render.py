...
def test_format_receipt_minimal_golden():
    ...
    core = render.format_receipt(
        entries, now=FIXED_NOW, motto=MOTTO, product_line=PRODUCT_LINE)
    ...
    assert core == (
        ...
        '----------------------------------------------\n'
        f'  Generated by Cleanroom · {PRODUCT_LINE}\n'
        '==============================================\n'
    )
...
def test_format_receipt_timeline_golden():
    ...
    core = render.format_receipt(
        moved, days_bought=12.4, now=FIXED_NOW, motto=MOTTO,
...
def test_format_receipt_with_proof_matches_shim(tmp_path):
    ...
    core = render.format_receipt(
        entries, proof=prf, now=FIXED_NOW, motto=MOTTO,
        product_line=PRODUCT_LINE,
    )
    assert core == expected
