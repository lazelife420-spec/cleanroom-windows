...
PROOF_FOUNDRY_NAME = 'The Proof Foundry'
PROOF_FOUNDRY_MARK = 'The Proof Foundry™'
PROOF_FOUNDRY_SHORT = 'Proof Foundry'
PROOF_FOUNDRY_TAGLINE = 'Build it. Prove it. Ship it.'
PROOF_FOUNDRY_BYLINE = 'Product by The Proof Foundry™'
APP_PUBLIC_BYLINE = 'Cleanroom is a Proof Foundry product.'
APP_BRAND_BYLINE = f'{PROOF_FOUNDRY_BYLINE} · {PROOF_FOUNDRY_TAGLINE}'
APP_LOCKUP_TAGLINE = 'Archive-first cleanup, with receipts.'
APP_LOCKUP_PILL = 'Receipt-backed'
LIGHTS_OUT_RELEASE_URL = 'https://github.com/lazelife420-spec/lights-out/releases/latest'
...
def _write_migration_receipt(dest_dir, legacy_dir, files_copied, total_bytes, hashes):
    ...
    lines.extend([f'  Generated by Cleanroom · {PROOF_FOUNDRY_BYLINE}', '=' * 46, ''])
